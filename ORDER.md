...
https://github.com/jaxassistant55/jax-micro-offer-studio/issues/4
...
Use the catalog row for Website Audit Microservice Starter at $150, then move to the repo-specific structured form or order board for public-safe scope intake. The catalog is not payment proof. Paid work or transfer starts only after accepted scope and external payment proof through a seller-owned checkout, invoice, marketplace order, funded milestone, or payment request.
